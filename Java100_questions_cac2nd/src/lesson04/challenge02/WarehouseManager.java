...
public class WarehouseManager {
	...
	public static void main(String[] args) throws IOException {
		...
		//ここに入力処理を記述する。
		String detagataString = br.readLine();
		int detagata = Integer.parseInt(detagataString);

		System.out.print("\n要素数を選んでください（1...1個、2...2個、3...3個）＞");

		//ここに入力処理を記述する。
		String yousosuuString = br.readLine();
		int yousosuu = Integer.parseInt(yousosuuString);

		boolean errFlag = false;

		//ここに入力値の範囲チェック処理を記述する。
		if ((detagata < 1 || detagata > 3) || (yousosuu < 1 || yousosuu > 3)) {
			errFlag = true;
		}
