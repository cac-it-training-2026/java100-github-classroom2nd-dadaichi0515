...
public class WarehouseManager {
	...
	public static void main(String[] args) {
		...
		do {
			for (int i = gusuIndex; i < ABKosanArray1.length; i++) {
			...
			for (int i = kisuIndex; i < ABKosanArray2.length; i++) {
				if (ABKosanArray2[i] % 2 != 0) {
					kisuIndex = i;
					int temp = ABKosanArray1[gusuIndex];
					ABKosanArray1[gusuIndex] = ABKosanArray2[i];
