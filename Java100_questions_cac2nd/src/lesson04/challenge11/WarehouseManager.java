	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < MQArrayE.length; i++) {
			...
			if (kazu == 0) {
				...
				MQArrayE[i] = (int) (Math.random() * 10) + 1;
			}
		...
		//ここに配列Cの要素をすべて出力する処理を記述する。
		for (int i = 0; i < MQArrayX[0].length; i++) {
			System.out.print(MQArrayX[0][i]);
			if (i != MQArrayX[0].length - 1) {
				System.out.print(",");
			}
		}
		...
		//ここに配列Dの要素をすべて出力する処理を記述する。
		for (int i = 0; i < MQArrayX[1].length; i++) {
			System.out.print(MQArrayX[1][i]);
			if (i != MQArrayX[1].length - 1) {
				System.out.print(",");
			}
		}
		...
		//ここに配列Eの要素をすべて出力する処理を記述する。
		for (int i = 0; i < MQArrayX[2].length; i++) {
			System.out.print(MQArrayX[2][i]);
			if (i != MQArrayX[2].length - 1) {
				System.out.print(",");
			}
		}
