...
public class WarehouseManager {
	...
	public static void main(String[] args) throws IOException {
		...
		//ここに入力処理を記述する
		String yousosuString = br.readLine();
		int yousosuu = Integer.parseInt(yousosuString);

		//ここに配列宣言を記述する
		String[] yoArray;
		yoArray = new String[yousosuu];

		//ここに値の入力+代入処理を記述する（for文）
		for (int i = 0; i < yousosuu; i++) {
			System.out.print("\n代入する値を入れてください>");
			yoArray[i] = br.readLine();
