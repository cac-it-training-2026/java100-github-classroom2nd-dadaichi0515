...
class Robot {
	...
	void makeOmelet(int eggNum, int butterNum) {
		int eggOmelet = eggNum / 2;
		int butterOmelet = butterNum / 5;
		if (eggOmelet > butterOmelet) {
			System.out.println(butterOmelet + "人分のオムレツを作成しました。");
		} else {
			System.out.println(eggOmelet + "人分のオムレツを作成しました。");
		}
