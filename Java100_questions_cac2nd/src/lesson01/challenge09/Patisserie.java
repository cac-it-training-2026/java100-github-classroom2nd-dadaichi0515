...
public class Patisserie {
	public static void main(String[] args) throws IOException {
		...
		System.out.println("\nシトロンの味　　　・・・" + (int) (numstr / goukei * 100) + '%');
		System.out.println("ショコラの味　　　・・・" + (int) (numsyk / goukei * 100) + '%');
		System.out.println("ピスタージュの味　・・・" + (int) (numpst / goukei * 100) + '%');

		System.out.println("\nが楽しめます！");

		double sannsyoku = (25 * numstr / goukei + 28 * numsyk / goukei + 32 * numpst / goukei);

		int sansyoku2 = (int) sannsyoku;
